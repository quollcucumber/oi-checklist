...
const OLYMPIADS: { key: string; fullName: string }[] = [
  ...
  { key: 'IZhO', fullName: 'International Zhautykov Olympiad' },
  { key: 'FARIO', fullName: 'French-Australian Regional Informatics Olympiad' },
  { key: 'Singapore NOI', fullName: 'Singapore National Olympiad in Informatics' },
