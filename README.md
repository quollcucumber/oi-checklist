...
Covers **IOI**, **APIO**, **CEOI**, **Baltic OI**, **JOI Final / Spring Camp / Open**,
**IZhO**, **FARIO**, **Singapore NOI**, **eJOI**, **COI**, **COCI**, **EGOI**, **USACO**,
and **CNOI** (2150 problems), with data sourced from [oj.uz](https://oj.uz),
...
archive, the ORAC FARIO archive, USACO/LibreOJ metadata, and matching Codeforces mirror
contests:
